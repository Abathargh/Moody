...
class Logger() :
    ...
    def __init__ ( self, name ) :
        ...
        pathlib.Path ( "/home/pi/Tesi/Moody/moody/logs/" ).mkdir ( parents = True, exist_ok = True ) 
        
        
        self.logger = logging.getLogger( name )
        self.logger.setLevel ( logging.DEBUG )
        
        file_handler = logging.FileHandler ( "/home/pi/Tesi/Moody/moody/logs/{}-{}.log".format( name [ name.find ( "." ) + 1 : ],
                                                                                formatted_date ) )
